 ...
 */
final class Version20221128163823 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adoption_case (id INT AUTO_INCREMENT NOT NULL, dog_id INT NOT NULL, client_id INT NOT NULL, UNIQUE INDEX UNIQ_CC49025634DFEB (dog_id), UNIQUE INDEX UNIQ_CC4902519EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE documents (id INT AUTO_INCREMENT NOT NULL, adoption_case_id INT DEFAULT NULL, document_name VARCHAR(255) NOT NULL, document_source VARCHAR(255) NOT NULL, INDEX IDX_A2B07288B58FCD84 (adoption_case_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dog (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, age INT DEFAULT NULL, race VARCHAR(255) DEFAULT NULL, sex VARCHAR(30) DEFAULT NULL, description VARCHAR(1000) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, in_adoption TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, post_owner_id INT NOT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(2000) NOT NULL, image VARCHAR(255) DEFAULT NULL, INDEX IDX_5A8A6C8DC1D1E858 (post_owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, email VARCHAR(100) NOT NULL, description VARCHAR(1000) DEFAULT NULL, facebook_profile VARCHAR(255) DEFAULT NULL, phone_number INT DEFAULT NULL, profile_image VARCHAR(255) DEFAULT NULL, available TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
