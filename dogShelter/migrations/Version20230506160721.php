 ...
 */
final class Version20230506160721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, post_owner_id INT DEFAULT NULL, status_id INT NOT NULL, title VARCHAR(255) NOT NULL, content VARCHAR(5400) NOT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, archived TINYINT(1) NOT NULL, INDEX IDX_5A8A6C8DC1D1E858 (post_owner_id), INDEX IDX_5A8A6C8D6BF700BD (status_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
